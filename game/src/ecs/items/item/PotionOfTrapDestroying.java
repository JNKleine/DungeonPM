...
public class PotionOfTrapDestroying extends Item {
    ...
    public PotionOfTrapDestroying() {
        super(
                ItemType.Active,
                "items/potionOfTrapDestroying/potionOfTrapDestroyingInventoryAnimation",
                "items/potionOfTrapDestroying/potionOfTrapDestroyingWorldAnimation",
                "Potion of Trapdestroying",
