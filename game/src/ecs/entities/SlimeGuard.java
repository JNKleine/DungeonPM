...
public class SlimeGuard extends Monster  {
     ...
     * In addition, SlimeGuard receives specific components here that were not
     * generally received in monsters.</p>
     * */
    public SlimeGuard() {
        super(0.05f,0.05f,40+(Game.currentLevelNumber/10),
            2+(Game.currentLevelNumber/10),0.2f,3,
            "monster/slimeGuard/idleRight","monster/slimeGuard/idleLeft",
            "monster/slimeGuard/runRight","monster/slimeGuard/runLeft",Faction.FOE);
        addHitBox();
        addAIComponent();
        addHealthComponent();
    }
