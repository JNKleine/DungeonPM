...
public class WallWalker extends Monster {
     ...
     * superclass. In addition, WallWalker receives specific components here that were not generally
    ...
    public WallWalker() {
        super(
                ...
                1 + (Game.currentLevelNumber / 10),
                0.5f,
                1,
                "monster/wallWalker/idleRight",
                "monster/wallWalker/idleLeft",
                "monster/wallWalker/runRight",
                "monster/wallWalker/runLeft",
                Faction.FOE);
        addHitBox();
        addAIComponent();
        addHealthComponent();
