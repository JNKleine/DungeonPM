...
public class PillowOfBadDreams extends Monster {
     ...
     * superclass. In addition, PillowOfBadDreams receives specific components here that were not
     * generally received in monsters.
     */
    public PillowOfBadDreams() {
        super(
                0.1f,
                0.1f,
                20 + (Game.currentLevelNumber / 10),
                2 + (Game.currentLevelNumber / 10),
                0.1f,
                2,
                "monster/pillowOfBadDreams/idleRight",
                "monster/pillowOfBadDreams/idleLeft",
                "monster/pillowOfBadDreams/runRight",
                "monster/pillowOfBadDreams/runLeft",
                Faction.FOE);
        addHitBox();
        addAIComponent();
        addHealthComponent();
