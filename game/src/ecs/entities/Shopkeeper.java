...
public class Shopkeeper extends Entity {
    ...
    private ItemData[] possibleItemsInShop =
            new ItemData[] {
    ...
    private String getPrice(InventoryComponent ic, boolean itemIsForSell) {
        if (ic.getCurMainItem() != null) {
            if (itemIsForSell) {
                return "I want "
                        + (int) (ic.getCurMainItem().getValue() * currentPriceFactor)
                        + " Coins for this "
                        + ic.getCurMainItem().getItemName()
                        + "!";
            } else
                return "This "
                        + ic.getCurMainItem().getItemName()
                        + " would be "
                        + ic.getCurMainItem().getValue()
                        + " Coins worth!";
        } else {
    ...
    // Minigame, roll a dice and if you get an even number u win a dicsout, if u you get an odd
    // number items are more expensive
    private String rollDice() {
        ...
        if (currentPriceFactor == 1.1f)
            return "We've already haggled and you rolled a "
                    + dice
                    + "\nthat mean's you won\nyou now get a 10% discount on my items";
        else
            return "We've already haggled and you rolled a "
    ...
    public String getAnswer(String text) {
        ...
        } else if (text.toLowerCase().contains("my inventory")
                || text.toLowerCase().contains("my items")) {
            DialogueSystem.hideInventoryHUD();
        ...
        } else if (text.toLowerCase().contains("costs")
                || text.toLowerCase().contains("how much")) {
