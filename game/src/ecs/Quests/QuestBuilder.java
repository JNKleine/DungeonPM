...
public class QuestBuilder {
    ...
    private static Quest specialQUest =
            new Quest(
                    "Kill Telepeter",
                    "You need to kill the Telepeter, a strong enemy.\nThe ladder will lead you to him",
                    new KillTelepeterBehavior(),
                    QuestTag.KILL_TELEPETER,
                    "Emerald is your reward");
    ...
    private static void reRollQuests() {
        ...
        questSelection.add(
                new Quest(
                        "Kill Monsters",
                        "You need to kill " + numberOfMonsters + " opposing Monsters",
                        new KillFoeQuestBehavior(numberOfMonsters),
                        QuestTag.KILL_MONSTER,
                        "Completed - get Coins"));
        questSelection.add(
                new Quest(
                        "Collect Coins",
                        "You need a net worth of " + numberOfCoins + " gold at some point",
                        new CollectCoinsBehavior(numberOfCoins),
                        QuestTag.SAVE_COINS,
                        "Completed - get random Item"));
    }
