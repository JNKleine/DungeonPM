...
public class Quest {
     ...
     * Construct a Quest
     *
     * <p>A Quest needs descriptions, an Behavior and an unique QuestTag. The QuestTag is for this
     * specific Quest and for all their objectives. E.g. if an Entity is a QuestObjective, this
     * Entity should get the QuestObjectiveComponent and the QuestTag from this Quest
     *
     ...
     */
    public Quest(
            String questShortDescription,
            String questDescription,
            QuestBehavior questCondition,
            QuestTag questTag,
            String finishedText) {
        ...
        this.questShortDescriptionWithProgress =
                shortDescription + " " + questCondition.getConditionToString();
    }
    ...
    public void checkCondition() {
        ...
        if (questIsFinished && !alreadyChecked) {
            alreadyChecked = true;
            questLogger.info(
                    "Quest " + this.getShortQuestDescriptionWithProgress() + " is finished");
            this.questShortDescriptionWithProgress =
                    shortDescription + "(" + questIsFinishedQuestText + ")";
    ...
    public void getReward(Entity e) {
        questLogger.info(
                "Quest " + this.getShortQuestDescriptionWithProgress() + " reward requested");
