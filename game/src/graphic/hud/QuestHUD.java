...
public class QuestHUD<T extends Actor> extends ScreenController<T> {
    ...
    public void createQuestHUD() {
        ...
        ScreenText questNumber =
                new ScreenText(
                        qlC.getQuestList().size() + "/" + qlC.getMaxQuestNumber(),
                        new Point(0, 0),
                        1f,
        ...
        if (qlC.isEmpty()) {
            ...
            for (int i = 0; i < questList.size(); i++) {
                ScreenText questText =
                        new ScreenText(
                                questList.get(i).getShortQuestDescriptionWithProgress(),
                                new Point(0, 0),
                                1f,
                                new LabelStyleBuilder(FontBuilder.DEFAULT_FONT)
                                        .setFontcolor(Color.GRAY)
                ...
                ScreenButton bt =
                        new ScreenButton("", new Point(questText.getX(), questText.getY()), tb);
